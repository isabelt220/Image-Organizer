 ...
 * regarding the location, path, name, type of the image file that the ImageData is attached to.
 */
public class ImageLocation implements Serializable{
    ...
    // String path is a substring of location and is the path of the image file that this ImageData is attached to. eg. C://User/phase2/
    private String path;
    ...
    /**
     * Checks if the other object is an ImageLocation Object, then check if it has the same absolute path as this ImageLocation.
     * Since all ImageLocations are attached to an ImageDta which is attached to an image file, and no two different image files will have the
     * same absolute path.
     * @param other Object for comparison with this ImageLocation
     * @return boolean whether or not this ImageLocation is conceptually the same as the other ImageLocation
     */
    @Override
    ...
    /**
     * Setter for location, does not alter any image file, merely an update of the imageLocation after a directory change of the
     * image file of the ImageData.
    ...
    /**
     * Getter for the type of image of the image file, various uses to check for types and display purposes.
     ...
     * @return String the current name of the image file.
     ...
     * @return the current location of the image file
     * eg. C:/Photos/SummerVacation/NotLeavingTheHouseForThreeMonthsStraight.jpg
     */
